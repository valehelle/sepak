...
grant select, insert, update, delete on public.slots    to service_role;
...
grant execute on function public.create_session(int, text, date, time, int, text, numeric, text, text, text)
  to service_role;
